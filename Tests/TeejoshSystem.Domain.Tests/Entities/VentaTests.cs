...
/// <summary>
/// Tests del agregado Venta y la clase VentaDetalle.
///
/// Mutantes objetivo en VentaDetalle:
///   - cantidad <= 0   → boundary en 0 (inválido) y 1 (válido)
///   - precioUnitario &lt; 0  → boundary en -0.01 (inválido) y 0 (válido)
///   - IsNullOrWhiteSpace → null, empty, whitespace
///   - Subtotal = Cantidad * PrecioUnitario → operador y operandos
///
/// Mutantes objetivo en Venta:
///   - Total += detalle.Subtotal → acumulación correcta con 1 y N detalles
///   - AgregarDetalle null → ArgumentNullException
///   - IReadOnlyList → no expone lista interna mutable
/// </summary>
